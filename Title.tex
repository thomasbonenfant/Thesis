...
\puttitle{
	title=Robot air hockey via hierarchical reinforcement learning, % Title of the thesis
	name=Thomas Jean Bernard Bonenfant, % Author Name and Surname
	course=Computer Science and Engineering - Ingegneria Informatica, % Study Programme (in Italian)
	ID  = 976252,  % Student ID number (numero di matricola)
